...
def asin(angle):
    ...
    if angle > 1:
        return "are you kidding me. the number you type is gigger than 1"
    elif angle <= -1:
        return "are you kidding me. the number you type is smaller than 1"
    elif angle == 1:
        return 0
...
def sec(angle):
    ...
    if awn > 3:
        word = "it might be wrong，because the number you type in sec is too large "
        print(word)
        return awn
    elif awn <= 3:
        return awn
...
def tanh(angle):
    ...
    list5 = mut(dev(1328,155925),expo(angle,11))
...
def asinh(angle):
    if angle > 1:
        return "are you kidding me, the number you type in asinh is bigger than 1."
    elif angle < -1:
        return "are you kidding me, the number you type in asinh is smaller than -1"
    elif angle == 1:
        return 0
    elif angle < 1 and angle > -1:
        list1 = dev(expo(angle,3),6)
        list2 = mut(dev(3,40),expo(angle,5))
        list3 = mut(dev(5,112),expo(angle,7))
        list4 = mut(dev(35,1152),expo(angle,9))
        return angle - list1 + list2 - list3 + list4
#太搞了
def acosh(angle):
...
def atanh(angle):
    if angle > 1:
        return "are you kidding me, the number you type in atanh is bigger than 1." 
    elif angle < -1:
        return "are you kidding me, the number you type in atanh is smaller than -1"
    elif angle == 1:
        return 0
    elif angle < 1 and angle > -1:
        list1 = dev(expo(angle,3),3)
        ...
        list6 = dev(expo(angle,13),13)
        list7 = dev(expo(angle,15),15)
        list8 = dev(expo(angle,17),17)
        list9 = dev(expo(angle,19),19)
        return angle + list1 + list2 + list3 + list4 + list5 + list6 + list7 + list8 + list9
